...
const AddWalletButton = ({ label = 'Add New Wallet', className = '', onClick }) => {
  return (
    <div className={`mx-auto py-4 ${className}`}>
      <button onClick={onClick} className="group relative w-full bg-[#D4FF00] hover:bg-[#bce600] text-black font-bold py-5 rounded-[24px] transition-all flex items-center justify-between px-6 overflow-hidden shadow-lg shadow-[#D4FF00]/20">
